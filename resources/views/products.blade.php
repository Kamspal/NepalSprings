...
<script src="http://127.0.0.1:8000/js/backend_js/sidebar/jquery.min.js"></script>
                ...
                <ul class="products columns-4">
                    <li class="post-2161 product type-product status-publish has-post-thumbnail product_cat-water product_tag-lemon product_tag-water first instock shipping-taxable purchasable product-type-simple">
                        <div class="matchHeight item" style="height: 581px;"> <a href="">
                                ...
                                <h2 class="woocommerce-loop-product__title">Bottled lemon water</h2>
                            </a>
                            <div class="post_content entry-content">Duis et aliquam orci. Vivamus augue quam, ...</div> <span class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>4.66</span></span> <a href="/shop/?add-to-cart=2161" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart btn" data-product_id="2161" data-product_sku="" aria-label="Add “Bottled lemon water” to your cart" rel="nofollow"> <i class="fa fa-shopping-cart pr-2"></i> Add to cart</a>
                        </div>
                    </li>
                    <li class="post-2163 product type-product status-publish has-post-thumbnail product_cat-water product_tag-soda product_tag-water instock shipping-taxable purchasable product-type-simple">
                        <div class="matchHeight item" style="height: 581px;"> <a href="">
                                ...
                                <h2 class="woocommerce-loop-product__title">Bottled sparkling water</h2>
                            </a>
                            <div class="post_content entry-content">Duis et aliquam orci. Vivamus augue quam, ...</div> <span class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>6.56</span></span> <a href="/shop/?add-to-cart=2163" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart btn" data-product_id="2163" data-product_sku="" aria-label="Add “Bottled sparkling water” to your cart" rel="nofollow"> <i class="fa fa-shopping-cart pr-2"></i> Add to cart</a>
                        </div>
                    </li>
                </ul>
            </div>
