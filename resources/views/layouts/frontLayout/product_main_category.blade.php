...
<h3 class="h3">All {{$submenu_name}} Products 
<a href="#" class="view-all ml-2"></a>
</h3>
...
<label for="rasanmart">Sort the product as per your need:</label>
  <select name="rasanmart" id="rasanmart" onchange="location = this.value;" >
       ...
       <option value="/product-main-category/{{$id}}?sort=updated_at&direction=desc">Sort by Latest</option>
       <option value="/product-main-category/{{$id}}?sort=updated_at&direction=asc">Sort by Oldest</option>
       <option value="/product-main-category/{{$id}}?sort=sale_price&direction=asc">Sort by price: Low to high</option>
    <option value="/product-main-category/{{$id}}?sort=sale_price&direction=desc">Sort by price: High to low</option>
    <option value="/product-main-category/{{$id}}?sort=product_name&direction=asc">Sort by Product Name: a-z</option>
    <option value="/product-main-category/{{$id}}?sort=product_name&direction=desc">Sort by Product Name: z-a</option>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body product-grid4">
                     ...
                     <input type="hidden"  name="product_id" value="{{$prod->id}}" />
                          ...
                          <div id="" class="total-amount">
                              <span style="margin-left: 70px;margin-top:10px">Price (NRs.)</span>
