...
@media only screen and (max-width:375px) {
  ...
  <select name="rasanmart" id="rasanmart" onchange="location = this.value;" >
       ...
       <option value="/feature-product?sort=updated_at&direction=asc">Sort by Latest</option>
       <option value="/feature-product?sort=updated_at&direction=asc">Sort by Oldest</option>
       <option value="/feature-product?sort=sale_price&direction=asc">Sort by price: Low to high</option>
    <option value="/feature-product?sort=sale_price&direction=desc">Sort by price: High to low</option>
    <option value="/feature-product?sort=product_name&direction=asc">Sort by Product Name: a-z</option>
    <option value="/feature-product?sort=product_name&direction=desc">Sort by Product Name: z-a</option>
...
$('#sidebarNavToggler').click();
  ...
  {!! $featured_product->appends(\Request::except('page'))->render() !!}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body product-grid4">
                     ...
                     <input type="hidden"  name="product_id" value="{{$prod->id}}" />
                          ...
                          <div id="" class="total-amount">
                              <span style="float: left;margin-left: 110px;margin-top:10px">Price (NRs.)</span>
        <input type="text" id="product-priceLatestModal{{$prod->id}}" name="totalprice" value="{{$prod->sale_price}}" style="border:none;width:21%;margin-top:12px">
                          </div>
                                    </div>
                                    <script type="text/javascript">
