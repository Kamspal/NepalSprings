...
<h3 class="h3"> All {{$category_name}} Products 
...
<label for="rasanmart">Sort the product as per your need:</label>
  <select name="rasanmart" id="rasanmart" onchange="location = this.value;" >
       ...
       <option value="/product-category/{{$id}}?sort=updated_at&direction=desc">Sort by Latest</option>
       <option value="/product-category/{{$id}}?sort=updated_at&direction=asc">Sort by Oldest</option>
       <option value="/product-category/{{$id}}?sort=sale_price&direction=asc">Sort by price: Low to high</option>
    <option value="/product-category/{{$id}}?sort=sale_price&direction=desc">Sort by price: High to low</option>
    <option value="/product-category/{{$id}}?sort=product_name&direction=asc">Sort by Product Name: a-z</option>
    <option value="/product-category/{{$id}}?sort=product_name&direction=desc">Sort by Product Name: z-a</option>
