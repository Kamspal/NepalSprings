...
@media only screen and (max-width:375px) {
  ...
  <select name="rasanmart" id="rasanmart" onchange="location = this.value;" >
       ...
       <option value="/latest-product?sort=updated_at&direction=asc">Sort by Latest</option>
       <option value="/latest-product?sort=updated_at&direction=asc">Sort by Oldest</option>
       <option value="/latest-product?sort=sale_price&direction=asc">Sort by price: Low to high</option>
    <option value="/latest-product?sort=sale_price&direction=desc">Sort by price: High to low</option>
    <option value="/latest-product?sort=product_name&direction=asc">Sort by Product Name: a-z</option>
    <option value="/latest-product?sort=product_name&direction=desc">Sort by Product Name: z-a</option>
