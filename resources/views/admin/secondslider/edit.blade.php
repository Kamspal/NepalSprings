      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form action="/secondslider/{{$slider->id}}/update" method="post" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="form-group mb-10">
                    ...
                    <div class="field" align="left">
                      <input type="file" id="slider_image" name="slider_image" /><img class="slider_image_css" src="/images/backend_images/secondslider/large/{{$slider->image}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group mb-10">
                    ...
                    <div class="field" align="left">
                      <input type="file" id="mobile_slider_image" name="mobile_slider_image" /><img class="slider_image_css" src="/images/backend_images/mobile-secondslider/large/{{$slider->mobile_image}}">
                    </div>
                  </div>

                  <div class="form-group">
                    <button type="submit" class="btn btn-primary">Submit</button>
                    <button type="cancel" class="btn btn-secondary"><a class="text-white" href="/secondslider">Cancel</a></button>
                  </div>
                </div>
              </div>
            </form>
